...
# bcs.add_bc("u", Constant((0, 0)), facet_id=4, bctype="strong_dirichlet")
...
prob_params.eco_penalty_multiplier = 0.4
prob_params.sed_penalty_multiplier = 100
...
farm_amb = RectangularFarm(domain, site_x_start, site_x_end,
                           site_y_start, site_y_end, turbine=turbine_amb)
...
if prob_params.ecology or prob_params.sediment:
    ...
    eco_fn = Eco_function(eco_x_start, eco_y_start, eco_x_end, eco_y_end)
    ...
    eco_mult = 800000000/flow
    prob_params.multiplier = eco_mult

# build the turbine farm
turbine = BumpTurbine(diameter=20.0, friction=21.0)
farm = RectangularFarm(domain, site_x_start, site_x_end,
                       site_y_start, site_y_end, turbine=turbine)
farm.add_regular_turbine_layout(num_x=10, num_y=8)
