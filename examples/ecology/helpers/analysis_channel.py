...
u_res_sed = Function(func_space, 'iter_69/p2p1_ures.xml')
u_res = Function(func_space, '../channel_opt_control/iter_69/p2p1_ures.xml')
...
eco_fn = Eco_function_corner(eco_x_start, eco_y_start, site_x_end, site_y_end)
